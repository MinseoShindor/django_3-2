...
class TestView(TestCase):
    ...
    def setUp(self):
        ...
        self.user_minseo = User.objects.create_user(username="minseo", password="eognsld905!")
        ...
        self.post_003 = Post.objects.create(title="세번째 포스트", content="세번째 포스트입니다.", author=self.user_minseo)
